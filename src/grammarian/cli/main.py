...
@cli.group()
def config() -> None:
    """Manage Grammarian configuration."""
    pass


EXAMPLE_CONFIG = '''\
# Grammarian Configuration File
# Generated by: grammarian config init
#
# Place this file as .grammarian.toml in your project root
...
@click.option(
    "--output", "-o",
    type=click.Path(),
    default=".grammarian.toml",
    help="Output file path (default: .grammarian.toml)",
)
@click.option(
    "--stdout", "-s",
    is_flag=True,
...
def config_init(output: str, stdout: bool, force: bool) -> None:
    ...
    Creates a comprehensive .grammarian.toml with all available options
    documented and example values. Use this as a starting point for
    customizing Grammarian for your project.
    ...
    Examples:
        ...
        grammarian config init --stdout | less
    """
    if stdout:
    ...
    console.print("  2. Run [cyan]grammarian analyze <files>[/cyan] to use your config")
    console.print()
    console.print("Tips:")
